...
import com.unis.hbase.model.FaceSnapStructured;
import com.unis.hbase.service.FaceSnapService;
...
public class FaceSnapServiceImpl implements FaceSnapService {
    ...
    @Override
    public String makeFaceSnapData(long passTime, long recordID) {
